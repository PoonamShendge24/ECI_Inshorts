...
const values=['HOME','PAYMENTS','NEWS','PAYMENTS','SERVICES','ANALYTICS'];
...
class MenuNavigationScreen extends React.Component {
	handleBackOnPress = () => {
    ...
    return (
      ...
      <View style={styles.container}>
       <View style={{
         ...
         <Text style={{fontSize: 30}}>ECI INSHORTS</Text>
...
const styles = StyleSheet.create({
  ...
  frame: {
		...
		width: frameWidth,
		backgroundColor:'#ff4081',
		paddingTop: frameWidth/0.75,
	  },
	  but: {
		backgroundColor:'white',
		width: frameWidth/3.5,
		height: frameWidth/6,
		paddingTop: frameWidth/18,
		margin: 5,
		borderRadius: 10,
		paddingBottom: frameWidth/20,
		alignItems:'center',
		borderColor: 'red',
		borderWidth: 1.5,
